...
const std::string symbols = "xyzabcdef";
...
int main(int argc, char *argv[]) {
    ...
    // auto expression = A(A(C(s2), A(A(C(s2), C(i2)), A(C(k2), C(s2)))), A(C(k2), C(k2)));

    auto expression = parse_string("λx.((λy.y(y((λz.zz)(λz.λa.λb.(b(λc.λd.d))((λc.(((zz)c)((λd.dd)(λd.c(dd)))))(λc.λd.λe.λf.(fd)(e(ac)))))(λz.λa.λb.y(bz)))))(λy.λz.(z(λa.λb.a)y)))");
